export interface SeedReply {
  ...
  style: 'Direct & Professional' | 'Condescending' | 'Overly Verbose' | 'Disrespectful';
  score: number;
...
export const ALL_SEED_REPLIES: SeedReply[] = [
  // ==========================================
  // Juan's 6 Replies (IBM & NVIDIA)
  // ==========================================
  {
    id: '#REP-J01',
    brand: 'IBM',
    specialistId: 'aaaaaaaa-1111-0000-0000-000000000001',
    specialistName: 'Juan (Specialist)',
    style: 'Condescending',
    score: 45,
    status: 'Critical',
    dateAgo: '6 days ago',
    caseTitle: 'Unindexed queries & root crash',
    content:
  ...
  },
  {
    ...
    specialistId: 'aaaaaaaa-1111-0000-0000-000000000001',
    specialistName: 'Juan (Specialist)',
    style: 'Overly Verbose',
    score: 72,
    status: 'In Review',
    dateAgo: '5 days ago',
    caseTitle: 'RTX GPU reboot & 12VHPWR seating',
    content:
  ...
  },
  {
    ...
    status: 'Resolved',
    dateAgo: '4 days ago',
    caseTitle: 'Hybrid cloud replication latency MTU mismatch',
    content:
  ...
  },
  {
    ...
    status: 'Critical',
    dateAgo: '3 days ago',
    caseTitle: 'Tower on high-pile shag carpet blocking intake',
    content:
  ...
  },
  {
    ...
    status: 'In Review',
    dateAgo: '2 days ago',
    caseTitle: 'Batch job memory consumption tuning',
    content:
  ...
  },
  {
    ...
    status: 'Resolved',
    dateAgo: '1 day ago',
    caseTitle: 'CUDA OOM on PyTorch inference',
    content:
  ...
  // ==========================================
  // Carla's 8 Replies (NVIDIA & APPLE)
  // ==========================================
  {
    id: '#REP-C01',
    brand: 'APPLE',
    specialistId: 'aaaaaaaa-2222-0000-0000-000000000002',
    specialistName: 'Carla (Specialist)',
    style: 'Direct & Professional',
    score: 97,
    status: 'Resolved',
    dateAgo: '7 days ago',
    caseTitle: 'MacBook battery drain during sleep',
    content:
  ...
  },
  {
    ...
    status: 'Critical',
    dateAgo: '6 days ago',
    caseTitle: 'Phone dropped from 2nd floor balcony',
    content:
  ...
  },
  {
    ...
    status: 'In Review',
    dateAgo: '5 days ago',
    caseTitle: 'Monitor plugged into motherboard HDMI instead of GPU',
    content:
  ...
  },
  {
    ...
    status: 'In Review',
    dateAgo: '4 days ago',
    caseTitle: 'Thick metal folio case blocking induction charging',
    content:
  ...
  },
  {
    ...
    status: 'Resolved',
    dateAgo: '3 days ago',
    caseTitle: 'Enterprise vGPU license sync expiration',
    content:
  ...
  },
  {
    ...
    status: 'In Review',
    dateAgo: '2 days ago',
    caseTitle: 'Mac Studio warm during 8K ProRes render',
    content:
  ...
  },
  {
    ...
    status: 'In Review',
    dateAgo: '1 day ago',
    caseTitle: 'DisplayPort audio crackle and DAC underflow',
    content:
  ...
  },
  {
    ...
    score: 40,
    status: 'Critical',
    dateAgo: '12 hours ago',
    caseTitle: 'Swimming with AirPods Pro in chlorinated pool',
    content:
...
/**
 * Filter replies simulating Supabase Row Level Security (RLS) policies:
 * - If specialist: can ONLY see records created by themselves (specialistId === user.id)
 * - If team_lead: can see records created by themselves OR by specialists assigned to brands managed by this team_lead
 */
export function getRepliesForUser(userId: string, role: string, assignedBrands: string[] = []): SeedReply[] {
  if (role === 'specialist') {
    return ALL_SEED_REPLIES.filter((r) => r.specialistId === userId);
  }

  if (role === 'team_lead') {
    return ALL_SEED_REPLIES.filter((r) => {
      // 1. Records created by the team lead themself
      if (r.specialistId === userId) return true;
      // 2. Records of brands managed by this team lead
      return assignedBrands.includes(r.brand);
    });
  }

  return ALL_SEED_REPLIES;
}
